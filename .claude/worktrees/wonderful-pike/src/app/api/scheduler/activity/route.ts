...
const AGENT_STATUSES = [
  ...
  { id: 'analytics-vp', name: 'Analytics VP', role: 'VP of Analytics', department: 'analytics', avatar_color: 'emerald', status: 'working', current_task: 'Analyzing AgentIQ channel performance — CTR below target' },
  ...
  { id: 'shorts-and-clips-agent', name: 'Shorts & Clips Agent', role: 'Short-Form Specialist', department: 'content', avatar_color: 'cyan', status: 'working', current_task: 'Clipping 3 Shorts from latest AgentIQ video' },
  ...
  { id: 'senior-researcher', name: 'Senior Researcher', role: 'Senior Researcher', department: 'analytics', avatar_color: 'emerald', status: 'working', current_task: 'Deep research: AI agent market trends for AgentIQ content' },
  ...
  { id: 'data-analyst', name: 'Data Analyst', role: 'Data Analyst', department: 'analytics', avatar_color: 'emerald', status: 'working', current_task: 'Building CTR benchmark model across AgentIQ top 10 videos' },
      ...
      escalations: [
        {
          ...
          reason: 'AgentIQ CTR dropped below 4% — last 3 videos underperforming vs. 5.2% channel average',
          severity: 'high',
          thread_id: 'thread-1',
