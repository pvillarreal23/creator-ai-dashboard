...
const AGENT_STATUSES = [
  ...
  { id: 'analytics-vp', name: 'Analytics VP', role: 'VP of Analytics', department: 'analytics', avatar_color: 'emerald', status: 'working', current_task: 'Analyzing The AI Edge channel performance — CTR below target' },
  ...
  { id: 'shorts-and-clips-agent', name: 'Shorts & Clips Agent', role: 'Short-Form Specialist', department: 'content', avatar_color: 'cyan', status: 'working', current_task: 'Clipping 3 Shorts from latest The AI Edge video' },
  ...
  { id: 'senior-researcher', name: 'Senior Researcher', role: 'Senior Researcher', department: 'analytics', avatar_color: 'emerald', status: 'working', current_task: 'Deep research: AI agent market trends for The AI Edge content' },
  ...
  { id: 'data-analyst', name: 'Data Analyst', role: 'Data Analyst', department: 'analytics', avatar_color: 'emerald', status: 'working', current_task: 'Building CTR benchmark model across The AI Edge top 10 videos' },
      ...
      escalations: [
        {
          ...
          reason: 'The AI Edge CTR dropped below 4% — last 3 videos underperforming vs. 5.2% channel average',
          severity: 'high',
          thread_id: 'thread-1',
