...
DEFAULT_TASKS = [
    ...
    {"agent_id": "ai-and-tech-channel-manager", "name": "Weekly Content Proposals", "cron": "0 9 * * 2", "category": "content",
     "prompt": "Propose 5 video topics for AgentIQ this week. Use your CONTENT PROPOSAL format. Prioritize by trending potential and SEO opportunity. Include at least 1 evergreen and 1 trending topic."},
