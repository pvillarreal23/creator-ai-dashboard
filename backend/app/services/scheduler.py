...
DEFAULT_TASKS = [
    ...
    # Content VP
    {"agent_id": "content-vp-agent", "name": "Daily Content Calendar Review", "cron": "0 8 * * *", "category": "content",
    ...
    {"agent_id": "content-vp-agent", "name": "Weekly Performance Debrief", "cron": "0 14 * * 5", "category": "content",
    ...
    # Operations VP
    {"agent_id": "operations-vp-agent", "name": "Daily Pipeline Health Check", "cron": "0 7 * * *", "category": "operations",
    ...
    {"agent_id": "operations-vp-agent", "name": "Weekly Capacity Review", "cron": "0 9 * * 5", "category": "operations",
    ...
    # Analytics VP
    {"agent_id": "analytics-vp-agent", "name": "Daily Metrics Pull", "cron": "0 6 * * *", "category": "analytics",
    ...
    {"agent_id": "analytics-vp-agent", "name": "Weekly Analytics Report", "cron": "0 10 * * 1", "category": "analytics",
    ...
    # Monetization VP
    {"agent_id": "monetization-vp-agent", "name": "Weekly Revenue Report", "cron": "0 10 * * 2", "category": "monetization",
    ...
    {"agent_id": "monetization-vp-agent", "name": "Monthly Partnership Pipeline Review", "cron": "0 11 1 * *", "category": "monetization",
    ...
    # Channel Managers
    {"agent_id": "ai-and-tech-channel-manager-agent", "name": "Daily AI Trend Scan", "cron": "0 7 * * *", "category": "content",
    ...
    {"agent_id": "ai-and-tech-channel-manager-agent", "name": "Weekly Content Proposals", "cron": "0 9 * * 2", "category": "content",
    ...
    {"agent_id": "finance-channel-manager-agent", "name": "Daily Finance News Scan", "cron": "0 7 * * *", "category": "content",
    ...
    {"agent_id": "finance-channel-manager-agent", "name": "Weekly Content Proposals", "cron": "0 9 * * 2", "category": "content",
    ...
    {"agent_id": "psychology-channel-manager-agent", "name": "Weekly Content Proposals", "cron": "0 9 * * 2", "category": "content",
    ...
    # Research
    {"agent_id": "trend-researcher-agent", "name": "Daily Trend Briefing", "cron": "30 6 * * *", "category": "analytics",
    ...
    {"agent_id": "senior-researcher-agent", "name": "Weekly Research Roundup", "cron": "0 8 * * 1", "category": "analytics",
    ...
    # SEO
    {"agent_id": "seo-specialist-agent", "name": "Weekly SEO Audit", "cron": "0 8 * * 3", "category": "analytics",
    ...
    # Data Analyst
    {"agent_id": "data-analyst-agent", "name": "Daily Performance Snapshot", "cron": "0 6 * * *", "category": "analytics",
    ...
    # Scriptwriter
    {"agent_id": "scriptwriter-agent", "name": "Script Queue Check", "cron": "0 8 * * *", "category": "content",
    ...
    # Newsletter
    {"agent_id": "newsletter-strategist-agent", "name": "Weekly Newsletter Draft", "cron": "0 10 * * 4", "category": "monetization",
    ...
    {"agent_id": "newsletter-strategist-agent", "name": "Monthly List Growth Report", "cron": "0 9 1 * *", "category": "monetization",
    ...
    # QA
    {"agent_id": "qa-lead-agent", "name": "Daily QA Queue Check", "cron": "0 9 * * *", "category": "operations",
    ...
    # Project Manager
    {"agent_id": "project-manager-agent", "name": "Daily Standup Report", "cron": "0 8 * * 1-5", "category": "operations",
    ...
    # Compliance
    {"agent_id": "compliance-officer-agent", "name": "Weekly Compliance Audit", "cron": "0 10 * * 3", "category": "executive",
    ...
    # Web Designer
    {"agent_id": "web-designer-agent", "name": "Weekly UI Audit", "cron": "0 10 * * 4", "category": "operations",
     "prompt": "Audit the Creator AI Dashboard UI. Review design consistency, identify areas needing improvement, check responsive behavior, and propose specific design changes with Tailwind classes. Prioritize by impact."},

    # Web Developer
    {"agent_id": "web-developer-agent", "name": "Weekly Code Health Check", "cron": "0 10 * * 5", "category": "operations",
     "prompt": "Run a code health check on the dashboard. Review component structure, check for performance issues, identify tech debt, and propose specific improvements. Include actual code suggestions."},

    # Reflection Council
    {"agent_id": "reflection-council-agent", "name": "Weekly Retrospective", "cron": "0 15 * * 5", "category": "executive",
    ...
    # Affiliate
    {"agent_id": "affiliate-coordinator-agent", "name": "Weekly Affiliate Report", "cron": "0 9 * * 2", "category": "monetization",
    ...
    # Partnership Manager
    {"agent_id": "partnership-manager-agent", "name": "Weekly Outreach Pipeline", "cron": "0 10 * * 1", "category": "monetization",
    ...
    # Community Manager
    {"agent_id": "community-manager-agent", "name": "Daily Community Pulse", "cron": "0 8 * * *", "category": "monetization",
    ...
    # Social Media
    {"agent_id": "social-media-manager-agent", "name": "Daily Social Calendar", "cron": "0 7 * * *", "category": "content",
    ...
    # Thumbnail
    {"agent_id": "thumbnail-designer-agent", "name": "Thumbnail Queue Check", "cron": "0 9 * * *", "category": "operations",
    ...
    # Digital Products
    {"agent_id": "digital-product-manager-agent", "name": "Monthly Product Review", "cron": "0 11 1 * *", "category": "monetization",
